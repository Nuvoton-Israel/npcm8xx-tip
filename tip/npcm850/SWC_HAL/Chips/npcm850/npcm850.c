...
/*                 																						   */
/*---------------------------------------------------------------------------------------------------------*/
DEFS_STATUS			CHIP_MuxFLM(FLM_MODULE_T flm_module, FLM_MODE_T mode, BOOLEAN quad_en)
{
		switch (flm_module)
		{
			case FLM_MODULE_0:
...
{
    if ((smb_module > (SMB_MODULE_T)7) || (segment > 3))
    {
        return;
    }
    ...
    case 0:
        {
            REG_WRITE(I2CSEGCTL, (REG_READ(I2CSEGCTL) & 0x03FC0000) | BUILD_FIELD_VAL(I2CSEGCTL_SMB0SS, segment) | BUILD_FIELD_VAL(I2CSEGCTL_WEN0SS, 1));
            SET_REG_FIELD(I2CSEGSEL, I2CSEGSEL_S0SBSEL, 0);
            SET_REG_FIELD(I2CSEGSEL, I2CSEGSEL_S0SCSEL, 0);
            SET_REG_FIELD(I2CSEGSEL, I2CSEGSEL_S0SDSEL, 0);
            if (bEnable == TRUE)
        ...
        case 1:
        {
            REG_WRITE(I2CSEGCTL, (REG_READ(I2CSEGCTL) & 0x03FC0000) | BUILD_FIELD_VAL(I2CSEGCTL_SMB1SS,segment) | BUILD_FIELD_VAL(I2CSEGCTL_WEN1SS,1));
         ...
         case 2:
         {
            REG_WRITE(I2CSEGCTL, (REG_READ(I2CSEGCTL) & 0x03FC0000) | BUILD_FIELD_VAL(I2CSEGCTL_SMB2SS, segment) | BUILD_FIELD_VAL(I2CSEGCTL_WEN2SS, 1));
        ...
        case 3:
        {
            REG_WRITE(I2CSEGCTL, (REG_READ(I2CSEGCTL) & 0x03FC0000) | BUILD_FIELD_VAL(I2CSEGCTL_SMB3SS, segment) | BUILD_FIELD_VAL(I2CSEGCTL_WEN3SS, 1));
        ...
        case 4:
        {
            REG_WRITE(I2CSEGCTL, (REG_READ(I2CSEGCTL) & 0x03FC0000) | BUILD_FIELD_VAL(I2CSEGCTL_SMB4SS, segment) | BUILD_FIELD_VAL(I2CSEGCTL_WEN4SS, 1));
       ...
       case 5:
       {
            REG_WRITE(I2CSEGCTL, (REG_READ(I2CSEGCTL) & 0x03FC0000) | BUILD_FIELD_VAL(I2CSEGCTL_SMB5SS, segment) | BUILD_FIELD_VAL(I2CSEGCTL_WEN5SS, 1));
        ...
        case 6:
        {
             REG_WRITE(I2CSEGCTL, (REG_READ(I2CSEGCTL) & 0x03FC0000) | BUILD_FIELD_VAL(I2CSEGCTL_SMB6SS, segment) | BUILD_FIELD_VAL(I2CSEGCTL_WEN5SS, 1));
        ...
        case 7:
        {
             REG_WRITE(I2CSEGCTL, (REG_READ(I2CSEGCTL) & 0x03FC0000) | BUILD_FIELD_VAL(I2CSEGCTL_SMB7SS, segment) | BUILD_FIELD_VAL(I2CSEGCTL_WEN5SS, 1));
...
/*---------------------------------------------------------------------------------------------------------*/
/* Function:        CHIP_Mux_SMB11DDC                                                                       */
/*                                                                                                         */
/* Parameters:                                                                                             */
/*                  subsegment - 0 => SMB11 control, 1 => SMB11 DDC emulation                                              */
/*                                                                                                         */
/* Returns:         none                                                                                   */
/* Side effects:                                                                                           */
/* Description:                                                                                            */
/*                  This routine selects the SMB11 function to the corresponding pin.                       */
/*---------------------------------------------------------------------------------------------------------*/
void CHIP_Mux_SMB11DDC (UINT32 subsegment)
{
    if (subsegment == 0) /* SMB11 pin is selected */
    {
        SET_REG_FIELD(MFSEL4, MFSEL4_SMB11DDC, 0x0);
    }
    else if (subsegment == 1) /* DDC pin is selected */
    {
        SET_REG_FIELD(MFSEL4, MFSEL4_SMB11DDC, 0x1);
    }
