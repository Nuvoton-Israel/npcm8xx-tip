...
/*---------------------------------------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------------------------------------*/
#undef CHIP_INTERRUPT_PROVIDER
#define CHIP_INTERRUPT_PROVIDER     INTERRUPT_PROVIDER_NVIC
...
/* GPIO TIP Module                                                                                         */
/*---------------------------------------------------------------------------------------------------------*/
#define GPIO_TIP_MODULE_TYPE                  5
#define GPIO_TIP_ACCESS                       MEM
#define GPIO_TIP_HANDLER_T                    SW_HANDLER_T
#define GPIO_TIP_EVENT_SUPPORT
#define GPIO_TIP_INTERRUPT(gpio)              NVIC_INT_18
#define GPIO_TIP_INTERRUPT_PROVIDER           INTERRUPT_PROVIDER_NVIC
#define GPIO_TIP_INTERRUPT_POLARITY           INTERRUPT_POLARITY_RISING_EDGE
#define GPIO_TIP_INTERRUPT_PRIORITY           5
#define GPIO_TIP_MUX(gpio, a_or_b , lock)     CHIP_MuxGPIO_TIP(gpio, a_or_b, lock)
/* Note: Each TIP GPIO can be routed to A\B pins */
#define GPIO_TIP_NUM_OF_PORTS                 2
#define GPIO_TIP_NUM_OF_GPIOS                 8

#define TIP_GPIO0_A                       0x00
#define TIP_GPIO0_B                       0x10
#define TIP_GPIO1_A                       0x01
#define TIP_GPIO1_B                       0x11
#define TIP_GPIO2_A                       0x02
#define TIP_GPIO2_B                       0x12
#define TIP_GPIO3_A                       0x03
#define TIP_GPIO3_B                       0x13
#define TIP_GPIO4_A                       0x04
#define TIP_GPIO4_B                       0x14
#define TIP_GPIO5_A                       0x05
#define TIP_GPIO5_B                       0x15
#define TIP_GPIO6_A                       0x06
#define TIP_GPIO6_B                       0x16
#define TIP_GPIO7_A                       0x07
#define TIP_GPIO7_B                       0x17
#define TIP_GPIO_ALL                0xFFFFFFFF


/*---------------------------------------------------------------------------------------------------------*/
/* FLM Module                                                                                              */
/*---------------------------------------------------------------------------------------------------------*/
#ifndef FLM_MODULE_TYPE
#define FLM_MODULE_TYPE 1
#endif 

#ifdef FLM_MODULE_TYPE
#define FLM_BASE_ADDR(n)                    (0xF0210000 + (0x1000L * (n)))
#define FLM_ACCESS                          MEM
#define FLM_INTERRUPT(module)               CHIP_FLM_INT(module)
#define FLM_INTERRUPT_MODULE(int_num)       CHIP_FLM_INT_MODULE((NVIC_INT_SRC_T)int_num)
#define FLM_INTERRUPT_POLARITY              INTERRUPT_POLARITY_RISING_EDGE
#define FLM_INTERRUPT_PRIORITY              0
#define FLM_INTERRUPT_PROVIDER              INTERRUPT_PROVIDER_NVIC
#define FLM_NUM_OF_MODULES                  4
#define FLM_MUX(module, mode, quadEn)               CHIP_MuxFLM(module, mode, quadEn)
#endif
...
/* JTM Module                                                             */
/*---------------------------------------------------------------------------------------------------------*/
#ifndef JTM_MODULE_TYPE
#define JTM_MODULE_TYPE 1
#endif 


#ifdef JTM_MODULE_TYPE
#define JTM_BASE_ADDR(n)                    (0xF0208000 + (0x1000L * (n)))
#define JTM_ACCESS                          MEM
#define JTM_INTERRUPT(module)               CHIP_JTM_INT(module)
#define JTM_INTERRUPT_MODULE(int_num)       CHIP_JTM_INT_MODULE((NVIC_INT_SRC_T)int_num)
#define JTM_INTERRUPT_POLARITY              INTERRUPT_POLARITY_RISING_EDGE
#define JTM_INTERRUPT_PRIORITY              0
#define JTM_INTERRUPT_PROVIDER              INTERRUPT_PROVIDER_NVIC
#define JTM_NUM_OF_MODULES                  2
#define JTM_MUX(module)               		CHIP_MuxJTM(module)
#define JTM_RESET(module,state)             CHIP_ResetJTM(module,state)
#endif
...
#define  SMB_INT0     (NVIC_INT_56)
#define  SMB_INT1     (NVIC_INT_57)
#define  SMB_INT2     (NVIC_INT_58)
#define  SMB_INT3     (NVIC_INT_59)
#define  SMB_INT4     (NVIC_INT_60)
#define  SMB_INT5     (NVIC_INT_61)
#define  SMB_INT6     (NVIC_INT_62)
#define  SMB_INT7     (NVIC_INT_63)
#define  SMB_INT8     (NVIC_INT_64)
#define  SMB_INT9     (NVIC_INT_65)
#define  SMB_INT10    (NVIC_INT_66)
#define  SMB_INT11    (NVIC_INT_67)
#define  SMB_INT12    (NVIC_INT_68)
#define  SMB_INT13    (NVIC_INT_69)
#define  SMB_INT14    (NVIC_INT_70)
#define  SMB_INT15    (NVIC_INT_71)
#define  SMB_INT16    (NVIC_INT_72)
#define  SMB_INT17    (NVIC_INT_73)
#define  SMB_INT18    (NVIC_INT_74)
#define  SMB_INT19    (NVIC_INT_75)
#define  SMB_INT20    (NVIC_INT_76)
#define  SMB_INT21    (NVIC_INT_77)
#define  SMB_INT22    (NVIC_INT_78)
#define  SMB_INT23    (NVIC_INT_79)

#define  SMB_INT24    (NVIC_INT_38)
#define  SMB_INT25    (NVIC_INT_39)
#define  SMB_INT26    (NVIC_INT_40)


/* module to interrupt number: */
#define SMB_INTERRUPT(mod)    (((mod) < 24)? (SMB_INT0 + (mod)) : (SMB_INT24 + (mod)))

/* interrupt to module number: */
#define SMB_INTERRUPT_MODULE(int_num)       (((int_num) <= SMB_INT26) ? ((int_num) - NVIC_INT_38): ((int_num) -  NVIC_INT_56))

#undef SMB_INTERRUPT_PROVIDER
