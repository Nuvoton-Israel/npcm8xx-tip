...
#define FINAL_TEST_SIGNATURE_PROPERTY   168,        2,          FUSE_ECC_NONE
#define DIE_LOCATION_PROPERTY           170,        3,          FUSE_ECC_NONE
#define OEM_IDENTIFIER_CODE             173,        2,          FUSE_ECC_NIBBLE_PARITY
#define RNG_CONFIGURATION_PROPERTY      175,        10,         FUSE_ECC_NIBBLE_PARITY
#define SERIAL_NUMBER_PROPERTY          186,        4,          FUSE_ECC_NONE
#if defined _ARBEL_Z1_
#define NO_SKIP_TO_FLASH                191,        1,          FUSE_ECC_NONE
#endif
...
#define REVOCATION_MDLR                 1200,       8,          FUSE_ECC_NIBBLE_PARITY
