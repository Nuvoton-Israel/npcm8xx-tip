...
// BLOCKS 21-30 (General Purpose 21-30)
#define GP_21_30_LENGTH                 (128)
#define GP_21_30_OFFSET(n)              (1920 + ((n) - 21) * GP_21_30_LENGTH)
#define GP_21_30_PROPERTY(n)            GP_21_30_OFFSET(n), 128, FUSE_ECC_NONE
...
// BLOCKS 58-61 (General Purpose 59-63)
#define FUSE_BLOCK58_OFFSET             6912
#define GP_59_63_OFFSET(n)              (6912 + (n) * 256)
#define GP_59_63_PROPERTY(n)            GP_59_63_OFFSET(n), 256, FUSE_ECC_NONE
...
DEFS_STATUS FUSE_WRPR_set (UINT16 fuse_address, UINT16 fuse_length, FUSE_ECC_TYPE_T fuse_ecc,
	UINT8 *value);
DEFS_STATUS FUSE_WRPR_get (UINT16 fuse_address, UINT16 fuse_length, FUSE_ECC_TYPE_T fuse_ecc,
	UINT8 *value);
