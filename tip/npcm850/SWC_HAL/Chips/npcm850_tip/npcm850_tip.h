...
#undef GPIO_INTERRUPT
#undef GPIO_INTERRUPT_PROVIDER           
#undef GPIO_INTERRUPT_POLARITY           
#undef GPIO_INTERRUPT_PRIORITY
#undef GPIO_MUX
#undef GPIO_NUM_OF_PORTS
#undef GPIO_NUM_OF_GPIOS

#define GPIO_HANDLER_T                    SW_HANDLER_T
#define GPIO_MODULE_TYPE  5
#define GPIO_EVENT_SUPPORT
#define GPIO_INTERRUPT(gpio)              NVIC_INT_18
#define GPIO_INTERRUPT_PROVIDER           INTERRUPT_PROVIDER_NVIC
#define GPIO_INTERRUPT_POLARITY           INTERRUPT_POLARITY_RISING_EDGE
#define GPIO_INTERRUPT_PRIORITY           0
#define GPIO_MUX(gpio, a_or_b)            CHIP_MuxGPIO_TIP(gpio, a_or_b)
/* Note: Each TIP GPIO can be routed to A\B pins */
#define GPIO_NUM_OF_PORTS                 2
#define GPIO_NUM_OF_GPIOS                 8
