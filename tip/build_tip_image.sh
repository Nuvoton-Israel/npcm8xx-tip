...
GCC_ARM_COMPILER_RELEASE=10.3-2021
GCC_ARM_COMPILER_VERSION=$GCC_ARM_COMPILER_RELEASE.$GCC_ARM_COMPILER_BUILD
...
if [ $? -ne 0 ]; then
	...
	wget https://developer.arm.com/-/media/Files/downloads/gnu-rm/$GCC_ARM_COMPILER_VERSION/gcc-arm-none-eabi-$GCC_ARM_COMPILER_VERSION-x86_64-linux.tar.bz2
	tar -xvf gcc-arm-none-eabi-$GCC_ARM_COMPILER_VERSION-x86_64-linux.tar.bz2
	export PATH=$PATH:$(pwd)/tools/gcc-arm-none-eabi-$GCC_ARM_COMPILER_VERSION/bin
