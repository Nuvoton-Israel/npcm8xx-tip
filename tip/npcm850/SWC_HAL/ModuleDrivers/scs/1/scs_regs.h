...
/*---------------------------------------------------------------------------------------------------------*/
/* Debug registers support in the SCB                                                                      */
/*---------------------------------------------------------------------------------------------------------*/
#define SCS_DHCSR               (SCS_BASE_ADDR + 0xDF0), SCS_ACCESS, 32
#define SCS_DCRSR               (SCS_BASE_ADDR + 0xDF4), SCS_ACCESS, 32
#define SCS_DCRDR               (SCS_BASE_ADDR + 0xDF8), SCS_ACCESS, 32
...
/* SCS_DHCSR fields                                                                                        */
/*---------------------------------------------------------------------------------------------------------*/
#define SCS_DHCSR_C_DEBUGEN         0,   1

/*---------------------------------------------------------------------------------------------------------*/
/* SCS_DEMCR fields                                                                                        */
/*---------------------------------------------------------------------------------------------------------*/
#define SCS_DEMCR_MON_EN            16,  1
#define SCS_DEMCR_MON_PEND          17,  1
#define SCS_DEMCR_MON_STEP          18,  1
#define SCS_DEMCR_MON_REQ           19,  1
