...
typedef union HEADER_GENERAL_tag {
	struct {
		...
		uint16_t  next_version;                  /* 0x96 (150)                                                                                  */
		uint16_t  version;                       /* 0x98 (152)                                                                                  */
		uint8_t   reservedSigned2[0x12];         /* 0x9A (154)               ( challenge, IV..  ROM only)                                       */
		uint8_t   aes_cbc_iv[16];                /* 0xAC (172)               ( challenge, IV..  ROM only)                                       */
		uint32_t  timestamp;                     /* 0xBC (188)                                                                                  */
...
struct tip_L1_system_control {
	uint32_t tip_system_control_flag;  /* SystemControlFlags in TipFwAndHeader_L1 header */
