...
#define INTCR2_WOL                            17,   1               /* 17 TIP detected WOL reset. */
#define INTCR2_FORCE_RESTART                  16,   1               /* 16 TIP Forced reset. */
...
/***********************************************************************************************************/
#define MCRn(n)                            (GCR_BASE_ADDR + (0x800 + (4 * n))),  MEM,    32         /* Offset: 800h-87Ch */
...
#define MCRn_MDSP_S_INT_ALLOC                 16,    3               /* R/W   S_INT_ALOC (Set Interrupt Allocation). Defined the interrupt signal destination for the module protected by this register. */
#define MCRn_MDSP_TZONE                       15,    1               /* R/W   MDSP_TZONE (Master Disable Slave Protection on BMC). Defines if a Slave (Address range of MCRn_XXX register) belongs to a Secure area (TrustZone) and only the TIP core and BMC CPU */
...
/***********************************************************************************************************/
#define SCRPAD_42_73(n)                      (GCR_BASE_ADDR + 0xE80 + ( n ) * 4), MEM, 32
...
/**************************************************************************************************************************/
#ifndef GPnOSRC
#define  GPnOSRC(n)                        (GPIO_BASE_ADDR(n) + 0x005C) , GPIO_ACCESS, 32
#endif
