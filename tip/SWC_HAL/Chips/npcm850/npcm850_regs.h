...
#define INTCR2_TIP_RESET                      25,   1               /* 25 TIP_RESET (TIP Reset Status). This bit is set by TIP reset (from TIP) */
...
#define RESSR_TIP_RESET                       25,   1               /* 25 TIP_RESET (TIP Reset Status). This bit is set by TIP reset (from TIP) */
