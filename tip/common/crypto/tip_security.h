...
int  tip_image_hash (HEADER_GENERAL_T* imgHeaderInRAM, uint8_t* imageAddr, uint32_t imageLen, uint8_t* hash);
int  tip_image_auth_ECC (HEADER_GENERAL_T* imgHeaderInRAM, uint8_t* imageAddr, uint32_t imageLen, uint8_t* key, uint8_t* hash, SECURED_BOOLEAN_T *sigOK);
int  tip_image_auth_LMS (HEADER_GENERAL_T* imgHeaderInRAM, uint8_t* imageAddr, uint32_t imageLen, uint8_t* key, uint8_t* hash, SECURED_BOOLEAN_T *sigOK);
...
typedef NCL_STATUS_T (*ROM_NCL_DRBG_Instantiate) (
	...
	/* NCL_DFT:*/
															const uint8_t*  entropy, const uint8_t*  nonce, 
