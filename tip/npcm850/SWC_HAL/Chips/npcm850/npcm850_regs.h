...
/***********************************************************************************************************/
#define MCRn(n)                            (GCR_BASE_ADDR + (0xE00 + (4 * n))),  MEM,    32         /* Offset: E00h-E7Ch */
...
#define MCRn_MDSP_TZONE                       16,    3               /* R/W   MDSP_TZONE (Master Disable Slave Protection on BMC). Defines if a Slave (Address range of MCRn_XXX register) belongs to a Secure area (TrustZone) and only the TIP core and BMC CPU */
#define MCRn_MDSP_ESPI                        15,    1               /* R/W   MDSP_ESPI (Master Disable Slave Protection on ESPI). When set, disables access of ESPI module to protected range.  */
