	...
	size_t length, uint8_t *hash, size_t hash_length)
{
	...
	status = tip_Security_Sha_Calc (tip_ncl->context.ncl_sha, NCL_SHA_TYPE_2_256, data, length, hash);
	...
	size_t length, uint8_t *hash, size_t hash_length)
{
	...
	NCL_STATUS_RET_CHECK (pROM_NCL_SHA_Reset (tip_ncl->context.ncl_sha));
	status = tip_Security_Sha_Calc (tip_ncl->context.ncl_sha, NCL_SHA_TYPE_2_384, data, length, hash);
	...
	size_t length, uint8_t *hash, size_t hash_length)
{
	...
	NCL_STATUS_RET_CHECK (pROM_NCL_SHA_Reset (tip_ncl->context.ncl_sha));
	status = tip_Security_Sha_Calc (tip_ncl->context.ncl_sha, NCL_SHA_TYPE_2_512, data, length, hash);
