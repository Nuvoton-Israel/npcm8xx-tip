...
typedef union HEADER_GENERAL_tag {
	struct {
		...
		/* Start signed area: */
		uint8_t   reservedSigned[24];            /* 0x70        0x18        Reserved, signed.                                                  */
		uint32_t  key_mask_select;               /* 0x88       4 - A2 only                                                                     */
		uint32_t  KeyIndex;                      /* 0x8C         140       - A1 only                                                           */
		uint8_t   reservedSigned1[5];            /* 0x90         5        Reserved, signed.                                                    */
		uint8_t   enableLMS;                     /* 0x95                  whether LMS is anbled or not .    signed                            */
		...
		uint8_t   reservedSigned3[0xF4];         /* 0xC0         0xF4        Reserved, signed.                                                 */

		uint32_t  regs_offset;                   /* 0x1B4        0x4         offset to the external register table                             */
		uint8_t   reservedSigned4[0x40];         /* 0x1B8        0x40        Reserved, signed.                                                 */
