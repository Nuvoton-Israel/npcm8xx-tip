...
struct tip_cmd_channel {
	...
	struct cmd_channel_state channel_state;		/**< Variable state context for the channel. */
...
int tip_receive_packet (const struct cmd_channel *channel, struct cmd_packet *packet, int ms_timeout);
