 ...
 */
#define FL_CERBERUS_BASE_ADDR(addr)			( addr - 0xC0000 )

/**
 * The flash address for the key store
 */
#define KEY_STORE_ADDR(addr)			   ( FL_CERBERUS_BASE_ADDR(addr) )

/**
 * The flash address where application context information will be stored. Currently no used.
 */
#define APP_CONTEXT_ADDR(addr)			( FL_CERBERUS_BASE_ADDR(addr) + 0x10000 )

/**
 * The flash address for storing system state information.
 */
#define SYSTEM_STATE_ADDR(addr)			(FL_CERBERUS_BASE_ADDR(addr) + 0x20000 )

/**
 * Flash address for the first PCD region.
 */
#define PCD_REGION1_ADDR(addr)  ( FL_CERBERUS_BASE_ADDR(addr) + 0x40000 )

/**
 * Flash address for the second PCD region.
 */
#define PCD_REGION2_ADDR(addr)  ( FL_CERBERUS_BASE_ADDR(addr) + 0x60000 )

/**
 * Flash addresses for storing first CFM.
 */
#define CFM_REGION1_ADDR(addr)  ( FL_CERBERUS_BASE_ADDR(addr) + 0x80000 )

/**
 * Flash addresses for storing second CFM.
 */
#define CFM_REGION2_ADDR(addr)  ( FL_CERBERUS_BASE_ADDR(addr) + 0xA0000 )
...
/**
 * The maximum size for a RoT firmware image. Each FW region will be up to this size.
 */
#define ROT_COMBO0_MAX_SIZE 			_2MB_
 ...
 * images.
 */
#define ROT_COMBO0_ADDR_DEFAULT 		0
#define ROT_COMBO0_MAX_SIZE_DEFAULT 	_512KB_
#define ROT_COMBO1_ADDR_DEFAULT 		ROT_COMBO0_ADDR_DEFAULT + ROT_COMBO0_MAX_SIZE_DEFAULT
#define ROT_COMBO1_MAX_SIZE_DEFAULT 	_2MB_
