...
typedef enum
{
	...
	RESET_DBGRST_STS     = 0x2000, //TIP_RST_INDICATION_DBGRST_STS 13
	RESET_TIP            = 0x4000, //TIP_RST_INDICATION_TIP_SWRST_STS 14
	RESET_TIP_WD         = 0x8000, //TIP_RST_INDICATION_WDRST_STS 15
}  RESET_TYPE_T;
...
#define LIFE_CYCLE_PRODUCTION 0x3    /* Production Device (written by customer)                            */
#define LIFE_CYCLE_DEBUG      0x5    /* Debug (written by customer or Nuvoton)                             */
#define LIFE_CYCLE_NO_TIP     0x6    /* No TIP (written by Nuvoton)                                        */
#define LIFE_CYCLE_RMA_PQA    0x7    /* RMA or PQA (written by Nuvoton)                                    */
#define LIFE_CYCLE_EOL        0xF    /* EOL (written by customer or Nuvoton)                               */
#define LIFE_CYCLE_UNDEFINED  0xFF   /* Unknown or an undefined state)                                     */
...
struct tip_L1_system_control {
	...
	bool tip_disable_jtag;             /* bit 4 in SystemControlFlags */
