...
void CHIP_MuxGPIO_TIP (UINT gpio, UINT a_or_b, BOOLEAN lock)
{
    if (a_or_b == 0)
    {
        ...
        if (lock)
        {
            SET_REG_FIELD(MFSEL_LK1_7(7), MFSEL7_TPGPIOSEL_A(gpio), 1);
        }
    ...
    if (gpio <= 2)
    {
        ...
        if (lock)
        {
            SET_REG_FIELD(MFSEL_LK1_7(7), MFSEL7_TPGPIOSEL_B(gpio), 1);
        }
    }
    if (gpio == 4)
    {
        ...
        if (lock)
        {
            SET_REG_FIELD(MFSEL_LK1_7(5), MFSEL5_TPGPIO4SELB, 1);
        }
    }
    if (gpio == 5)
    {
        ...
        if (lock)
        {
            SET_REG_FIELD(MFSEL_LK1_7(5), MFSEL5_TPGPIO5SELB, 1);
        }
    }
   ...
   switch (gpio)
   {
        ...
        if (a_or_b == 0)
        {
            ...
            if (lock)
            {
                SET_REG_FIELD(MFSEL_LK1_7(1), MFSEL1_R2MDSEL, 1);
                SET_REG_FIELD(MFSEL_LK1_7(6), MFSEL6_CP1GPIO6SEL, 1);
            }
        }
        else
        {
            ...
            if (lock)
            {
                SET_REG_FIELD(FLOCKR1, FLOCKR1_LKGPO1SLK, 1);
            }
        }
        break;
        ...
        if (a_or_b == 0)
        {
            ...
            {
                SET_REG_FIELD(MFSEL_LK1_7(1), MFSEL1_R2MDSEL, 1);
                SET_REG_FIELD(MFSEL_LK1_7(6), MFSEL6_CP1GPIO7SEL, 1);
            }
        }
        else
        {
            ...
            if (lock)
            {
                SET_REG_FIELD(FLOCKR1, FLOCKR1_LKGPO2SLK, 1);
            }
        }
        break;
        ...
        if (a_or_b == 0)
        {
            ...
            if (lock)
            {
                SET_REG_FIELD(MFSEL_LK1_7(6), MFSEL6_CP1GPIO2SELC, 1);
                SET_REG_FIELD(MFSEL_LK1_7(5), MFSEL5_BU5SELB, 1);
            }
        }
        else
        {
            ...
            if (lock)
            {
                // note: no individual bit locks for I2CSEGSEL.
                SET_REG_FIELD(FLOCKR1, FLOCKR1_LKGPO0SLK, 1);
            }
        }
        break;
        ...
        case 3:
            ...
            if (lock)
            {
                SET_REG_FIELD(MFSEL_LK1_7(6), MFSEL6_CP1GPIO3SELC, 1);
                SET_REG_FIELD(MFSEL_LK1_7(5), MFSEL5_BU5SELB, 1);
            }
        break;
        ...
        case 4:
            ...
            if (lock)
            {
                SET_REG_FIELD(MFSEL_LK1_7(1), MFSEL1_R1MDSEL, 1);
                SET_REG_FIELD(MFSEL_LK1_7(5), MFSEL5_BU4SELB, 1);
            }
        break;
        ...
        case 5:
            ...
            {
                SET_REG_FIELD(MFSEL_LK1_7(1), MFSEL1_R1MDSEL, 1);
                SET_REG_FIELD(MFSEL_LK1_7(6), MFSEL6_CP1GPIO5SELB, 1);
                SET_REG_FIELD(MFSEL_LK1_7(5), MFSEL5_BU4SELB, 1);
            }
        break;
        ...
        case 6:
            ...
            if (lock)
            {
                SET_REG_FIELD(MFSEL_LK1_7(6), MFSEL6_CP1GPIO6SELB, 1);
                SET_REG_FIELD(MFSEL_LK1_7(4), MFSEL4_BU2SELB, 1);
            }
        break;
        ...
        case 7:
            ...
            if (lock)
            {
                SET_REG_FIELD(MFSEL_LK1_7(6), MFSEL6_CP1GPIO7SELB, 1);
                SET_REG_FIELD(MFSEL_LK1_7(4), MFSEL4_BU2SELB, 1);
            }
        break;
