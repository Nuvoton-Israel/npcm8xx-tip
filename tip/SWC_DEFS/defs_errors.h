...
/*---------------------------------------------------------------------------------------------------------*/
/* Macro:           NCL_STATUS_RET_CHECK                                                                   */
/*                                                                                                         */
/* Parameters:      func - function to check                                                               */
/*                                                                                                         */
/* Returns:         NCL_STATUS_T error in case of an error                                                 */
/* Side effects:                                                                                           */
/* Description:                                                                                            */
/*                  This macro checks if given function returns NCL_STATUS_T error                         */
/*---------------------------------------------------------------------------------------------------------*/
#define NCL_STATUS_RET_CHECK(func)                                  \
{                                                                   \
    NCL_STATUS_T ret;                                               \
                                                                    \
    if ((ret = func) != NCL_STATUS_OK)                              \
    {                                                               \
       HAL_PRINT (KRED "%s status %#010lx\n", __func__, ret) ;      \
       return ret;                                                  \
    }                                                               \
}
