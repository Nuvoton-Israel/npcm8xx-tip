...
#define	TIP_ECC_HW_NCL_ENGINE_VERIFY_ECC_PUBLIC_KEY \
		.verify_ecc_public_key = tip_ecc_hw_ncl_engine_verify_ecc_public_key,
#else
#define TIP_ECC_HW_NCL_ENGINE_VERIFY_ECC_PUBLIC_KEY
#endif
...
#define TIP_ECC_HW_API_INIT { \
		...
		TIP_ECC_HW_NCL_ENGINE_VERIFY_ECC_PUBLIC_KEY \
}
 ...
 */
#define	tip_ecc_hw_ncl_engine_static_init(state_ptr, shared_state_ptr)	{ \
