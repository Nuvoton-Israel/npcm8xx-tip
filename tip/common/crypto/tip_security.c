...
static int tip_init_rom_ncl_power_and_selftest (void);
...
/**
 *  Address of NCL on TIP ROM functions for Z1
 */
/* for Cortex-M4 need to add +1 to address in a branch command (BX) */
#define THUMB_BIT 1
#define TIP_ROM_Z1_ADDR_NCL_AES_ClearParams              ((ROM_NCL_AES_ClearParams)(0x000097fc + THUMB_BIT))
/*#define TIP_ROM_Z1_ADDR_NCL_AES_CONTEXT_SIZE             ((ROM_NCL_AES_CONTEXT_SIZE)(0x00011b64 + THUMB_BIT)) */
#define TIP_ROM_Z1_ADDR_NCL_AES_Decrypt                  ((ROM_NCL_AES_Decrypt)(0x0000985c + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_AES_GcmEncrypt               ((ROM_NCL_AES_GcmEncrypt)(0x000098bc + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_AES_Init                     ((ROM_NCL_AES_Init)(0x000095d4 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_AES_Power                    ((ROM_NCL_AES_Power)(0x00007ccc + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_AES_SelectKey                ((ROM_NCL_AES_SelectKey)(0x000096b0 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_AES_SelfTest                 ((ROM_NCL_AES_SelfTest)(0x00009924 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_AES_SetGcmParams             ((ROM_NCL_AES_SetGcmParams)(0x00009788 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_AES_SetKey                   ((ROM_NCL_AES_SetKey)(0x00009700 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_AES_SetParams                ((ROM_NCL_AES_SetParams)(0x00009620 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_convertToApiStatus_l         ((ROM_NCL_convertToApiStatus_l)(0x000015c4 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_DRBG_Config                  ((ROM_NCL_DRBG_Config)(0x00008f1c + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_DRBG_context_l               ((ROM_NCL_DRBG_context_l)(0x0006f0aa + THUMB_BIT))
/* #define TIP_ROM_Z1_ADDR_NCL_DRBG_CONTEXT_SIZE            ((ROM_NCL_DRBG_CONTEXT_SIZE)(0x00011b68 + THUMB_BIT)) */
#define TIP_ROM_Z1_ADDR_NCL_DRBG_FinalizeContext         ((ROM_NCL_DRBG_FinalizeContext)(0x00007cb0 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_DRBG_Generate                ((ROM_NCL_DRBG_Generate)(0x000090c4 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_RNG_IntHandler                   ((ROM_RNG_IntHandler)(0x000016b4 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_PKA_IntHandler                   ((ROM_PKA_IntHandler)(0x00004fb0 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_DRBG_Init                    ((ROM_NCL_DRBG_Init)(0x00008ed4 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_DRBG_InitContext             ((ROM_NCL_DRBG_InitContext)(0x00007c78 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_DRBG_Instantiate             ((ROM_NCL_DRBG_Instantiate)(0x00008f90 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_DRBG_Power                   ((ROM_NCL_DRBG_Power)(0x00007c94 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_DRBG_Reseed                  ((ROM_NCL_DRBG_Reseed)(0x00009054 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_DRBG_SelfTest                ((ROM_NCL_DRBG_SelfTest)(0x00009168 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_DRBG_UnInstantiate           ((ROM_NCL_DRBG_UnInstantiate)(0x00009000 + THUMB_BIT))
/* #define TIP_ROM_Z1_ADDR_NCL_ECC_CONTEXT_SIZE             ((ROM_NCL_ECC_CONTEXT_SIZE)(0x00011b6c + THUMB_BIT)) */
#define TIP_ROM_Z1_ADDR_NCL_ECC_ECDHKeyExchange          ((ROM_NCL_ECC_ECDHKeyExchange)(0x0000a520 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_ECC_ECDSASignData            ((ROM_NCL_ECC_ECDSASignData)(0x0000a1e4 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_ECC_ECDSASignHash            ((ROM_NCL_ECC_ECDSASignHash)(0x0000a274 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_ECC_ECDSAVerifyData          ((ROM_NCL_ECC_ECDSAVerifyData)(0x0000a308 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_ECC_ECDSAVerifyHash          ((ROM_NCL_ECC_ECDSAVerifyHash)(0x0000a38c + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_ECC_FinalizeContext          ((ROM_NCL_ECC_FinalizeContext)(0x00007d20 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_ECC_GenKey                   ((ROM_NCL_ECC_GenKey)(0x0000a410 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_ECC_Init                     ((ROM_NCL_ECC_Init)(0x0000a0f8 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_ECC_InitContext              ((ROM_NCL_ECC_InitContext)(0x00007d08 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_ECC_KdfFunc_l                ((ROM_NCL_ECC_KdfFunc_l)(0x0000a074 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_ECC_Power                    ((ROM_NCL_ECC_Power)(0x00007d38 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_ECC_SelfTest                 ((ROM_NCL_ECC_SelfTest)(0x0000a588 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_ECC_SetCurve                 ((ROM_NCL_ECC_SetCurve)(0x0000a174 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_MISC_GetStatus               ((ROM_NCL_MISC_GetStatus)(0x00007c40 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_MISC_Init                    ((ROM_NCL_MISC_Init_Z1)(0x00008e78 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_MISC_Mode_l                  ((ROM_NCL_MISC_Mode_l)(0x0006ecbc + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_MISC_SelfTest                ((ROM_NCL_MISC_SelfTest)(0x00008d54 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_MISC_status_l                ((ROM_NCL_MISC_status_l)(0x0006ecc6 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_RSA_Decrypt                  ((ROM_NCL_RSA_Decrypt)(0x00009350 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_RSA_Encrypt                  ((ROM_NCL_RSA_Encrypt)(0x00008a1c + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_RSA_GetStatus                ((ROM_NCL_RSA_GetStatus)(0x00009584 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_RSA_Init                     ((ROM_NCL_RSA_Init)(0x00009284 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_RSA_IntHandler_l             ((ROM_NCL_RSA_IntHandler_l)(0x00001600 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_RSA_keySizeInBytes_l         ((ROM_NCL_RSA_keySizeInBytes_l)(0x00011b70 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_RSA_SelfTest                 ((ROM_NCL_RSA_SelfTest)(0x00008af0 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_RSA_SetKey                   ((ROM_NCL_RSA_SetKey)(0x000092dc + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_RSA_SignHash                 ((ROM_NCL_RSA_SignHash)(0x00009400 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_RSA_VerifyHash               ((ROM_NCL_RSA_VerifyHash)(0x000094cc + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_rsaUserHandler_l             ((ROM_NCL_rsaUserHandler_l)(0x0006ecc0 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_SHA_Calc                     ((ROM_NCL_SHA_Calc)(0x00009c3c + THUMB_BIT))
/* #define TIP_ROM_Z1_ADDR_NCL_SHA_CONTEXT_SIZE             ((ROM_NCL_SHA_CONTEXT_SIZE)(0x00011b7c + THUMB_BIT)) */
#define TIP_ROM_Z1_ADDR_NCL_SHA_convertShaType_l         ((ROM_NCL_SHA_convertShaType_l)(0x00011a7a + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_SHA_FinalizeContext          ((ROM_NCL_SHA_FinalizeContext)(0x00007ce2 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_SHA_Finish                   ((ROM_NCL_SHA_Finish)(0x00009be8 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_SHA_HASH_SelfTest            ((ROM_NCL_SHA_HASH_SelfTest)(0x00009cfc + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_SHA_HKDF                     ((ROM_NCL_SHA_HKDF)(0x00009f14 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_SHA_HKDF_SelfTest            ((ROM_NCL_SHA_HKDF_SelfTest)(0x00009fa0 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_SHA_HMAC                     ((ROM_NCL_SHA_HMAC)(0x00009db0 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_SHA_HMAC_SelfTest            ((ROM_NCL_SHA_HMAC_SelfTest)(0x00009e30 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_SHA_Init                     ((ROM_NCL_SHA_Init)(0x00009adc + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_SHA_InitContext              ((ROM_NCL_SHA_InitContext)(0x00007cd8 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_SHA_Power                    ((ROM_NCL_SHA_Power)(0x00007cec + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_SHA_Reset                    ((ROM_NCL_SHA_Reset)(0x00009cb0 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_SHA_Start                    ((ROM_NCL_SHA_Start)(0x00009b30 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_SHA_Update                   ((ROM_NCL_SHA_Update)(0x00009b90 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_vendorRetStatus_l            ((ROM_NCL_vendorRetStatus_l)(0x0006ecc4 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_ECC_KdfFunc_l              ((ROM_NCL_ECC_KdfFunc_l)(0x0000a074 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_AES_Decrypt                ((ROM_NCL_AES_Decrypt)(0x0000985c + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_ECC_ECDSASignHash          ((ROM_NCL_ECC_ECDSASignHash)(0x0000a274 + THUMB_BIT))
#define TIP_ROM_Z1_ADDR_NCL_AES_SelfTest               ((ROM_NCL_AES_SelfTest)(0x00009924 + THUMB_BIT))
...
#define TIP_ROM_A1_ADDR_NCL_SHA_Calc                   ((ROM_NCL_SHA_Calc)(0x0001011c + THUMB_BIT))
...
ROM_NCL_SHA_Calc                   pROM_NCL_SHA_Calc;
...
/* missing function in Z1 */
static NCL_STATUS_T NCL_SHA_Clear_Z1 (void* context)
{
	NCL_STATUS_RET_CHECK(pROM_NCL_SHA_Reset (context));
	NCL_STATUS_RET_CHECK(pROM_NCL_SHA_FinalizeContext (context));
	return NCL_STATUS_OK;
}
/* missing function in Z1 */
static NCL_STATUS_T NCL_ECC_SetSeed_Z1 (void* context, uint32_t randSeed)
{
	return NCL_STATUS_OK;
}
 ...
 *  @return       void
 */
void tip_init_rom_ncl (void)
{
	uint32_t ChipVersion = CHIP_Get_Version();

	platform_printf (KGRN "Arbel NCL init" NEWLINE KNRM);
	if (ChipVersion > ARBEL_VERSION_Z1) {
		...
		pROM_NCL_SHA_Calc                 = TIP_ROM_A1_ADDR_NCL_SHA_Calc;
		...
		pROM_NCL_MISC_Init_Z1                = TIP_ROM_Z1_ADDR_NCL_MISC_Init;
		pROM_NCL_MISC_GetStatus              = TIP_ROM_Z1_ADDR_NCL_MISC_GetStatus;
		pROM_NCL_MISC_SelfTest               = TIP_ROM_Z1_ADDR_NCL_MISC_SelfTest;
		pROM_NCL_DRBG_InitContext            = TIP_ROM_Z1_ADDR_NCL_DRBG_InitContext;
		pROM_NCL_DRBG_Power                  = TIP_ROM_Z1_ADDR_NCL_DRBG_Power;
		pROM_NCL_DRBG_FinalizeContext        = TIP_ROM_Z1_ADDR_NCL_DRBG_FinalizeContext;
		pROM_NCL_DRBG_Init                   = TIP_ROM_Z1_ADDR_NCL_DRBG_Init;
		pROM_NCL_DRBG_UnInstantiate          = TIP_ROM_Z1_ADDR_NCL_DRBG_UnInstantiate;
		pROM_NCL_DRBG_Generate               = TIP_ROM_Z1_ADDR_NCL_DRBG_Generate;
		pROM_NCL_DRBG_Instantiate            = TIP_ROM_Z1_ADDR_NCL_DRBG_Instantiate;
		pROM_NCL_RSA_Init                    = TIP_ROM_Z1_ADDR_NCL_RSA_Init;
		pROM_NCL_RSA_GetStatus               = TIP_ROM_Z1_ADDR_NCL_RSA_GetStatus;
		pROM_NCL_RSA_SignHash                = TIP_ROM_Z1_ADDR_NCL_RSA_SignHash;
		pROM_NCL_RSA_VerifyHash              = TIP_ROM_Z1_ADDR_NCL_RSA_VerifyHash;
		pROM_NCL_RSA_Decrypt                 = TIP_ROM_Z1_ADDR_NCL_RSA_Decrypt;
		pROM_NCL_RSA_Encrypt                 = TIP_ROM_Z1_ADDR_NCL_RSA_Encrypt;
		pROM_NCL_RSA_SetKey                  = TIP_ROM_Z1_ADDR_NCL_RSA_SetKey;
		pROM_NCL_AES_Init                    = TIP_ROM_Z1_ADDR_NCL_AES_Init;
		pROM_NCL_AES_SetKey                  = TIP_ROM_Z1_ADDR_NCL_AES_SetKey;
		pROM_NCL_AES_SetParams               = TIP_ROM_Z1_ADDR_NCL_AES_SetParams;
		pROM_NCL_AES_SelectKey               = TIP_ROM_Z1_ADDR_NCL_AES_SelectKey;
		pROM_NCL_AES_ClearParams             = TIP_ROM_Z1_ADDR_NCL_AES_ClearParams;
		pROM_NCL_AES_Power                   = TIP_ROM_Z1_ADDR_NCL_AES_Power;
		pROM_NCL_AES_Decrypt                 = TIP_ROM_Z1_ADDR_NCL_AES_Decrypt;
		pROM_NCL_SHA_InitContext             = TIP_ROM_Z1_ADDR_NCL_SHA_InitContext;
		pROM_NCL_SHA_FinalizeContext         = TIP_ROM_Z1_ADDR_NCL_SHA_FinalizeContext;
		pROM_NCL_SHA_Clear                   = NCL_SHA_Clear_Z1;
		pROM_NCL_SHA_Init                    = TIP_ROM_Z1_ADDR_NCL_SHA_Init;
		pROM_NCL_SHA_Start                   = TIP_ROM_Z1_ADDR_NCL_SHA_Start;
		pROM_NCL_SHA_Update                  = TIP_ROM_Z1_ADDR_NCL_SHA_Update;
		pROM_NCL_SHA_Finish                  = TIP_ROM_Z1_ADDR_NCL_SHA_Finish;
		pROM_NCL_SHA_Power                   = TIP_ROM_Z1_ADDR_NCL_SHA_Power;
		pROM_NCL_SHA_Reset                   = TIP_ROM_Z1_ADDR_NCL_SHA_Reset;
		pROM_NCL_SHA_Calc                    = TIP_ROM_Z1_ADDR_NCL_SHA_Calc;
		pROM_NCL_ECC_InitContext             = TIP_ROM_Z1_ADDR_NCL_ECC_InitContext;
		pROM_NCL_ECC_FinalizeContext         = TIP_ROM_Z1_ADDR_NCL_ECC_FinalizeContext;
		pROM_NCL_ECC_Init                    = TIP_ROM_Z1_ADDR_NCL_ECC_Init;
		pROM_NCL_ECC_Power                   = TIP_ROM_Z1_ADDR_NCL_ECC_Power;
		pROM_NCL_ECC_SetCurve                = TIP_ROM_Z1_ADDR_NCL_ECC_SetCurve;
		pROM_NCL_ECC_SetSeed                   = NCL_ECC_SetSeed_Z1;
		pROM_NCL_ECC_ECDSAVerifyHash         = TIP_ROM_Z1_ADDR_NCL_ECC_ECDSAVerifyHash;
		pROM_NCL_ECC_ECDHKeyExchange         = TIP_ROM_Z1_ADDR_NCL_ECC_ECDHKeyExchange;
		pROM_NCL_ECC_ECDSASignData           = TIP_ROM_Z1_ADDR_NCL_ECC_ECDSASignData;
		pROM_NCL_ECC_ECDSASignHash           = TIP_ROM_Z1_ADDR_NCL_ECC_ECDSASignHash;
		pROM_NCL_ECC_ECDSAVerifyData         = TIP_ROM_Z1_ADDR_NCL_ECC_ECDSAVerifyData;
		pROM_NCL_ECC_GenKey                  = TIP_ROM_Z1_ADDR_NCL_ECC_GenKey;
		pROM_RNG_IntHandler                  = TIP_ROM_Z1_ADDR_RNG_IntHandler;
		pROM_PKA_IntHandler                  = TIP_ROM_Z1_ADDR_PKA_IntHandler;
	}
	if (ChipVersion == ARBEL_VERSION_A2){
		pROM_RNG_IntHandler                  = TIP_ROM_A2_ADDR_RNG_IntHandler;
		pROM_PKA_IntHandler                  = TIP_ROM_A2_ADDR_PKA_IntHandler;
	}
	
	sec_drbgInitialized = SECURED_FALSE;
	tip_init_rom_ncl_power_and_selftest ();
}

/**
 *  @function     tip_init_rom_ncl_power_and_selftest
 *  @brief
 *             This function runs the NCL initialization, powers the modules that are going to be
 *             used on, runs their selftests, and calls the secErrorFunc callback if any of them
 *             fails.
 *
...
static int tip_init_rom_ncl_power_and_selftest (void)
{
	...
	uint8_t context[NCL_ECC_CONTEXT_BYTE_SIZE];

	platform_printf ("Init NCL selftest\n");

	/*
	 * Init RNG module (for devices with empty OTP NCL)
	 */
	if (CHIP_Get_Version () >= ARBEL_VERSION_A1 ) { /* A1/A2 */
		REG_WRITE(RNGMODE(0), 0x03);
		REG_WRITE(RNGROEN(0, 0), 0xFF);
		REG_WRITE(RNGROEN(0, 1), 0xFF);
		REG_WRITE(RNGROEN(0, 2), 0x3F);

		/* TODO: depend on OTP bit FUSTRAP2_FIPS */
		ncl_stat = pROM_NCL_MISC_Init_A1 (NCL_FIPS_MODE, NULL);
		platform_printf (" pROM_NCL_MISC_Init_A1 status is 0x%x\n", ncl_stat);
		
	} else { /* Z1 */
		REG_WRITE(RNGMODE(0), 0x02);
		pROM_NCL_MISC_Init_Z1 (NULL);
	}
	...
	/* SHA module init*/
	pROM_NCL_SHA_Power ((void *)context, TRUE);
	pROM_NCL_SHA_InitContext((void *)context);
	pROM_NCL_MISC_SelfTest (NCL_ALGO_SHA, NULL);
	ncl_stat = pROM_NCL_MISC_GetStatus (NCL_ALGO_SHA);
	if (ncl_stat != NCL_STATUS_OK)
		platform_printf ("Init security failed SHA self test 0x%x\n", ncl_stat);
	
	/* DRBG module init */
	pROM_NCL_DRBG_Power ((void *)context, TRUE);
	pROM_NCL_MISC_SelfTest (NCL_ALGO_DRBG, NULL);
	ncl_stat = pROM_NCL_MISC_GetStatus (NCL_ALGO_DRBG);
	if (ncl_stat != NCL_STATUS_OK)
		platform_printf ("Init security failed DRBG self test 0x%x\n", ncl_stat);

	/* ECC module init*/
	pROM_NCL_ECC_Power ((void *)context, TRUE);
	pROM_NCL_MISC_SelfTest (NCL_ALGO_ECC, NULL);
	ncl_stat = pROM_NCL_MISC_GetStatus (NCL_ALGO_ECC);
	if (ncl_stat != NCL_STATUS_OK)
		platform_printf ("Init security failed ECC self test 0x%x\n", ncl_stat);
	
	platform_printf ("NCL selftest pass\n");  /* TBD: handling of NCL init fail */
							   ...
							   uint8_t *hash)
{
	...
	if (((uint32_t) imageAddr < TIP_DRAM_WIN0_BASE_ADDR) ||
		...
		nclStat_ret =
			pROM_NCL_SHA_Calc (shaCtx, NCL_SHA_TYPE_2_512, imageAddr, imageLen, (uint8_t *) hash);
	...
	*sigOK = SECURED_FALSE;
	...
	if (nclStat_ret == NCL_STATUS_OK) {
		if (nclStat == NCL_STATUS_OK) {
			...
			*sigOK = SECURED_FALSE;
			platform_printf ("ECDSAVerify nclStat_ret = %#010lx nclStat = %#010lx\n", nclStat_ret,
							 nclStat);
		}
	} else {
		*sigOK = SECURED_FALSE;
...
int mbedtls_hardware_poll (void *data, unsigned char *output, size_t len, size_t *olen)
{
	...
	static uint8_t drbgCtx[NCL_DRBG_CONTEXT_BYTE_SIZE] __attribute__ ((aligned (4)));

	/* DRBG init  - singleton */
	if (sec_drbgInitialized != SECURED_TRUE) {
		nclStat = pROM_NCL_DRBG_InitContext (drbgCtx);
		if (nclStat != NCL_STATUS_OK) {
			goto mbedtls_hardware_poll_error;
		}

		nclStat = pROM_NCL_DRBG_Init (drbgCtx, FALSE);
		if (nclStat != NCL_STATUS_OK) {
			goto mbedtls_hardware_poll_error;
		}

		sec_drbgInitialized = SECURED_TRUE;
	}

	nclStat =
		pROM_NCL_DRBG_Generate (NULL, NULL, 0, (uint8_t *)output, (uint32_t)len);
mbedtls_hardware_poll_error:
	if (nclStat == NCL_STATUS_OK) {
		*olen = len;
		return 0;
	} else {
