...
/* File Contents:                                                                                          */
/*       hal_cfg_L0.h                                                                                      */
/*            Arbel TIP FW L0 HAL main modules                                                             */
...
#define NCL_AES_CAPABILITY_KEY_SELECT_AND_LOCK
/*---------------------------------------------------------------------------------------------------------*/
#define PKA_CAPABILITY_ECC_OPCODE
#define PKA_CAPABILITY_EXTENDED_ECC
#define PKA_CAPABILITY_CMD_EXT
#define RSA_KEY_SIZE_MAX                    RSA_KEY_SIZE_3072b // for NCL usage
/* Print function                                                                                          */
/*---------------------------------------------------------------------------------------------------------*/
#define _DEBUG_
#ifdef _DEBUG_
